    ...
    <header className="sticky top-0 z-20 w-full border-b border-line/70 bg-white/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3 sm:px-12">
        <Link href="/" className="flex items-center gap-2.5">
          <Image src="/logo.jpg" alt={`Logo ${t.nav.orgName}`} width={32} height={32} className="rounded-lg" />
          <span className="font-display text-[15px] font-semibold tracking-tight text-navy">{t.nav.orgName}</span>
        </Link>
